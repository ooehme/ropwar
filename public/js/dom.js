export const dom = {
  ...
  capGps: document.querySelector('#capGps'),
  capCompass: document.querySelector('#capCompass'),
  capDepthGpu: document.querySelector('#capDepthGpu'),
  capDepthCpu: document.querySelector('#capDepthCpu'),
  capDepthOff: document.querySelector('#capDepthOff'),
